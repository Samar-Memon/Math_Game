let allLevelMultiplyOperators = [
    // Easy questions
    [
        {'value1': '2', 'operator': '×', 'value2': '3', 'answer': '6', 'option1': '5', 'option2': '6', 'option3': '7'},
        {'value1': '4', 'operator': '×', 'value2': '5', 'answer': '20', 'option1': '15', 'option2': '20', 'option3': '25'},
        {'value1': '6', 'operator': '×', 'value2': '7', 'answer': '42', 'option1': '36', 'option2': '42', 'option3': '49'},
        {'value1': '8', 'operator': '×', 'value2': '9', 'answer': '72', 'option1': '81', 'option2': '72', 'option3': '64'},
        ...
        {'value1': '7', 'operator': '×', 'value2': '8', 'answer': '56', 'option1': '49', 'option2': '56', 'option3': '63'},
        {'value1': '9', 'operator': '×', 'value2': '11', 'answer': '99', 'option1': '90', 'option2': '99', 'option3': '108'},
        {'value1': '12', 'operator': '×', 'value2': '2', 'answer': '24', 'option1': '22', 'option2': '24', 'option3': '26'},
    ...
    [
        ...
        {'value1': '25', 'operator': '×', 'value2': '12', 'answer': '300', 'option1': '275', 'option2': '300', 'option3': '325'},
        {'value1': '30', 'operator': '×', 'value2': '10', 'answer': '300', 'option1': '250', 'option2': '300', 'option3': '350'},
        {'value1': '35', 'operator': '×', 'value2': '9', 'answer': '315', 'option1': '290', 'option2': '315', 'option3': '340'},
        {'value1': '40', 'operator': '×', 'value2': '8', 'answer': '320', 'option1': '300', 'option2': '320', 'option3': '340'},
        {'value1': '45', 'operator': '×', 'value2': '7', 'answer': '315', 'option1': '300', 'option2': '315', 'option3': '330'},
        {'value1': '50', 'operator': '×', 'value2': '6', 'answer': '300', 'option1': '280', 'option2': '300', 'option3': '320'},
        {'value1': '55', 'operator': '×', 'value2': '5', 'answer': '275', 'option1': '250', 'option2': '275', 'option3': '300'},
        {'value1': '60', 'operator': '×', 'value2': '4', 'answer': '240', 'option1': '220', 'option2': '240', 'option3': '260'},
        {'value1': '65', 'operator': '×', 'value2': '3', 'answer': '195', 'option1': '180', 'option2': '195', 'option3': '210'},
    ],
    // Hard questions
    [
        {'value1': '123', 'operator': '×', 'value2': '456', 'answer': '56088', 'option1': '56087', 'option2': '56088', 'option3': '56089'},
        {'value1': '234', 'operator': '×', 'value2': '567', 'answer': '132678', 'option1': '132677', 'option2': '132678', 'option3': '132679'},
        {'value1': '345', 'operator': '×', 'value2': '678', 'answer': '233910', 'option1': '233909', 'option2': '233910', 'option3': '233911'},
        {'value1': '456', 'operator': '×', 'value2': '789', 'answer': '359784', 'option1': '359783', 'option2': '359784', 'option3': '359785'},
        {'value1': '567', 'operator': '×', 'value2': '890', 'answer': '504630', 'option1': '504629', 'option2': '504630', 'option3': '504631'},
        {'value1': '678', 'operator': '×', 'value2': '901', 'answer': '610278', 'option1': '610277', 'option2': '610278', 'option3': '610279'},
        {'value1': '789', 'operator': '×', 'value2': '123', 'answer': '97047', 'option1': '97046', 'option2': '97047', 'option3': '97048'},
        {'value1': '890', 'operator': '×', 'value2': '234', 'answer': '208260', 'option1': '208259', 'option2': '208260', 'option3': '208261'},
        {'value1': '901', 'operator': '×', 'value2': '345', 'answer': '310845', 'option1': '310844', 'option2': '310845', 'option3': '310846'},
        {'value1': '123', 'operator': '×', 'value2': '789', 'answer': '97047', 'option1': '97046', 'option2': '97047', 'option3': '97048'},
    ],
    // Extreme questions
    [
        {'value1': '12345', 'operator': '×', 'value2': '6789', 'answer': '83810205', 'option1': '83810204', 'option2': '83810205', 'option3': '83810206'},
        {'value1': '23456', 'operator': '×', 'value2': '7890', 'answer': '184827840', 'option1': '184827839', 'option2': '184827840', 'option3': '184827841'},
        {'value1': '34567', 'operator': '×', 'value2': '8901', 'answer': '307599567', 'option1': '307599566', 'option2': '307599567', 'option3': '307599568'},
        {'value1': '45678', 'operator': '×', 'value2': '9012', 'answer': '411513336', 'option1': '411513335', 'option2': '411513336', 'option3': '411513337'},
        ...
        {'value1': '78901', 'operator': '×', 'value2': '3456', 'answer': '272607456', 'option1': '272607455', 'option2': '272607456', 'option3': '272607457'},
        {'value1': '89012', 'operator': '×', 'value2': '4567', 'answer': '406589204', 'option1': '406589203', 'option2': '406589204', 'option3': '406589205'},
        {'value1': '90123', 'operator': '×', 'value2': '5678', 'answer': '511265394', 'option1': '511265393', 'option2': '511265394', 'option3': '511265395'},
        {'value1': '12345', 'operator': '×', 'value2': '6789', 'answer': '83810205', 'option1': '83810204', 'option2': '83810205', 'option3': '83810206'},
    ]
];
