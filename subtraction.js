let allLevelSubtractionOperators = [
    ...
    [
        ...
        { 'value1': '8', 'operator': '-', 'value2': '5', 'answer': '3', 'option1': '2', 'option2': '3', 'option3': '4' },
        { 'value1': '11', 'operator': '-', 'value2': '6', 'answer': '5', 'option1': '4', 'option2': '5', 'option3': '6' },
        { 'value1': '14', 'operator': '-', 'value2': '7', 'answer': '7', 'option1': '6', 'option2': '7', 'option3': '8' },
        { 'value1': '17', 'operator': '-', 'value2': '8', 'answer': '9', 'option1': '8', 'option2': '9', 'option3': '10' },
        { 'value1': '20', 'operator': '-', 'value2': '9', 'answer': '11', 'option1': '10', 'option2': '11', 'option3': '12' },
        ...
        { 'value1': '29', 'operator': '-', 'value2': '12', 'answer': '17', 'option1': '16', 'option2': '17', 'option3': '18' },
        { 'value1': '32', 'operator': '-', 'value2': '13', 'answer': '19', 'option1': '18', 'option2': '19', 'option3': '20' },
    ],
    // Medium questions
    [
        { 'value1': '35', 'operator': '-', 'value2': '15', 'answer': '20', 'option1': '18', 'option2': '20', 'option3': '22' },
        { 'value1': '40', 'operator': '-', 'value2': '18', 'answer': '22', 'option1': '20', 'option2': '22', 'option3': '24' },
        { 'value1': '45', 'operator': '-', 'value2': '20', 'answer': '25', 'option1': '23', 'option2': '25', 'option3': '27' },
        { 'value1': '50', 'operator': '-', 'value2': '22', 'answer': '28', 'option1': '26', 'option2': '28', 'option3': '30' },
        { 'value1': '55', 'operator': '-', 'value2': '24', 'answer': '31', 'option1': '29', 'option2': '31', 'option3': '33' },
        { 'value1': '60', 'operator': '-', 'value2': '26', 'answer': '34', 'option1': '32', 'option2': '34', 'option3': '36' },
        { 'value1': '65', 'operator': '-', 'value2': '28', 'answer': '37', 'option1': '35', 'option2': '37', 'option3': '39' },
        ...
        { 'value1': '80', 'operator': '-', 'value2': '34', 'answer': '46', 'option1': '44', 'option2': '46', 'option3': '48' },
    ],
    // Hard questions
[
    { 'value1': '85', 'operator': '-', 'value2': '36', 'answer': '49', 'option1': '47', 'option2': '49', 'option3': '51' },
    { 'value1': '90', 'operator': '-', 'value2': '38', 'answer': '52', 'option1': '50', 'option2': '52', 'option3': '54' },
    { 'value1': '95', 'operator': '-', 'value2': '40', 'answer': '55', 'option1': '53', 'option2': '55', 'option3': '57' },
    { 'value1': '100', 'operator': '-', 'value2': '42', 'answer': '58', 'option1': '56', 'option2': '58', 'option3': '60' },
    { 'value1': '105', 'operator': '-', 'value2': '44', 'answer': '61', 'option1': '59', 'option2': '61', 'option3': '63' },
    { 'value1': '110', 'operator': '-', 'value2': '46', 'answer': '64', 'option1': '62', 'option2': '64', 'option3': '66' },
    { 'value1': '115', 'operator': '-', 'value2': '48', 'answer': '67', 'option1': '65', 'option2': '67', 'option3': '69' },
    { 'value1': '120', 'operator': '-', 'value2': '50', 'answer': '70', 'option1': '68', 'option2': '70', 'option3': '72' },
    { 'value1': '125', 'operator': '-', 'value2': '52', 'answer': '73', 'option1': '71', 'option2': '73', 'option3': '75' },
    { 'value1': '130', 'operator': '-', 'value2': '54', 'answer': '76', 'option1': '74', 'option2': '76', 'option3': '78' },
],
// Extreme questions
[
    { 'value1': '135', 'operator': '-', 'value2': '56', 'answer': '79', 'option1': '77', 'option2': '79', 'option3': '81' },
    { 'value1': '140', 'operator': '-', 'value2': '58', 'answer': '82', 'option1': '80', 'option2': '82', 'option3': '84' },
    { 'value1': '145', 'operator': '-', 'value2': '60', 'answer': '85', 'option1': '83', 'option2': '85', 'option3': '87' },
    { 'value1': '150', 'operator': '-', 'value2': '62', 'answer': '88', 'option1': '86', 'option2': '88', 'option3': '90' },
    { 'value1': '155', 'operator': '-', 'value2': '64', 'answer': '91', 'option1': '89', 'option2': '91', 'option3': '93' },
    { 'value1': '160', 'operator': '-', 'value2': '66', 'answer': '94', 'option1': '92', 'option2': '94', 'option3': '96' },
    { 'value1': '165', 'operator': '-', 'value2': '68', 'answer': '97', 'option1': '95', 'option2': '97', 'option3': '99' },
    { 'value1': '170', 'operator': '-', 'value2': '70', 'answer': '100', 'option1': '98', 'option2': '100', 'option3': '102' },
    { 'value1': '175', 'operator': '-', 'value2': '72', 'answer': '103', 'option1': '101', 'option2': '103', 'option3': '105' },
    { 'value1': '180', 'operator': '-', 'value2': '74', 'answer': '106', 'option1': '104', 'option2': '106', 'option3': '108' },
]
];
